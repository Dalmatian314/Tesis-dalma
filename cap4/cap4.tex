...
\centering
\subfloat[]{%
  \includegraphics[width=0.34\linewidth]{cap4/figs/spec_alz.eps}
  \label{alz_spec}
}
\subfloat[]{%
  \includegraphics[width=0.34\linewidth]{cap4/figs/spec_cat.eps}
  \label{cat_spec}
}
\subfloat[]{%
  \includegraphics[width=0.34\textwidth]{cap4/figs/spec_fsd101.eps}
  \label{fsd101_spec}
}
...
\centering
\subfloat[]{%
  \includegraphics[width=0.34\linewidth]{cap4/figs/cargas_alz.eps}
  \label{alz_q}
}
\subfloat[]{%
  \includegraphics[width=0.34\linewidth]{cap4/figs/cargas_cat.eps}
  \label{cat_q}
}
\subfloat[]{%
  \includegraphics[width=0.34\textwidth]{cap4/figs/cargas_fsd101.eps}
  \label{fsd101_q}
}
...
\centering
\subfloat[]{%
  \includegraphics[width=0.4\linewidth]{cap4/figs/fig_6_a_crop.eps}
  \label{alz_c}
}
\subfloat[]{%
  \includegraphics[width=0.4\linewidth]{cap4/figs/fig_6_b_crop.eps}
  \label{cat_c}
}
\hspace{1cm}
\subfloat[]{%
  \includegraphics[width=0.4\textwidth]{cap4/figs/fig_6_c_crop.eps}
  \label{fsd101_c}
}
\caption{Espectros de absorción para los sistemas colorante-TiO$_2$ comparados con las pendientes de los promedios de las cargas dependientes del tiempo y la eficiencia del proceso de transferencia de carga entre el colorante y la NP ({\bf $\gamma$}) para ALZ {\bf (a)}, CAT {\bf (b)} y FSD101 {\bf (c)} en función de la energía ({\bf E}). Los valores positivos en las pendientes y las eficiencias corresponden a transferencia de electrones desde el colorante a la NP, mientras que valores negativos indican transferencia de huecos.}
\label{corriente}
\end{figure}
